...
Ruby on Rails. It allows you to create pretty URL's that work with
...
FriendlyId can be easily installed as a Ruby Gem:
...
discouraged:
  ...
  $ ruby /script/plugin install git://github.com/norman/friendly_id.git

== Setting it up

Here's how to set it up when used as Gem:
...
optionaly if you are planning to use slugged models:

  $ script/generate friendly_id
  $ rake db:migrate

2) Load FriendlyId in your app, modify your config/environment.rb file:

  # Rails 2.1 and higher; add this to the gem section.
  config.gem "friendly_id"

  # Rails 2.0; this goes at the bottom.
  require 'friendly_id'
...
==== Add FriendlyId to config/environment.rb:
...
If you have installed FriendlyId as a plugin into your Rails application:

  $ git rm -rf vendor/plugins/friendly_id
  $ svn delete vendor/plugins/friendly_id
  $ bzr rm vendor/plugins/friendly_id

Or whatever vodoo your SCM provides

====  Generate the upgrade migration and run it

  $ ruby script/generate friendly_id_20_upgrade
  $ rake db:migrate
